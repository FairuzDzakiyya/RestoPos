...
@section('content')
  <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    @if (session('success'))
    <div
    class="p-4 mb-4 text-sm text-green-800 rounded-lg border border-green-600 bg-green-50 dark:bg-gray-800 dark:text-green-400"
    role="alert">
    {{ session('success') }}
    </div>
  @endif
    ...
    <a href="#"
      ...
      <p class="font-normal text-gray-700 dark:text-gray-400">{{ $penjualan }} Penjualan</p>
    </a>
    <a href="#"
      class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
