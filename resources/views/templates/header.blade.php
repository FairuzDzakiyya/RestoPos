            ...
            <ul class="pb-2 space-y-2">
              ...
              <li>
                ...
                <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
                  <li>
                    <a href="/menu"
                      class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Menu</a>
                  </li>
                  <li>
                    <a href="/kategori"
                      class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Kategori</a>
                  </li>
                </ul>
              </li>
              <li>
              ...
              <li>
                <button type="button"
                  ...
                  <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Pengelolaan</span>
                </button>
                <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                  <li>
                    <a href="#"
                      class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Kelola
                      Stok</a>
                  </li>
                  <li>
                    <a href="#"
