...
@section('content')
    <div class="container mx-auto px-4 sm:px-6 py-4">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                        <div class="text-base font-semibold text-gray-900 dark:text-white">{{ $menu->menu }}</div>
                                        <div class="text-sm font-normal text-gray-500 dark:text-gray-400">{{ $menu->kategori->nama_kategori ?? '-' }}
                                        </div>
                                    </td>
                                    <td
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <button type="button"
                                            ...
                                            data-deskripsi="{{ $menu->deskripsi }}" data-kategori_id="{{ $menu->kategori->id ?? '' }}"
        ...
        <form action="{{ route('updateMenu') }}" method="POST" id="updateMenuForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        {{-- <input type="hidden" name="id" id="update-menu-id"> --}}
        <div class="space-y-4">
            <div>
                <label for="update-menu" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Menu</label>
            ...
            <div>
                <label for="update-harga" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga</label>
            ...
            <div>
                <label for="update-stok" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Stok</label>
            ...
            <div>
                <label for="updateKategori" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kategori</label>
            ...
            <div>
                <label for="update-deskripsi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi</label>
            ...
            <div class="mb-6">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="update-gambar">Upload Gambar</label>
        ...
        <div class="bottom-0 left-0 flex justify-center w-full space-x-4 md:px-4 md:relative">
            <button type="submit"
    ...
    <form id="deleteMenuForm" method="POST" action="{{ route('deleteMenu') }}">
        @csrf
        @method('DELETE')
        <button type="submit"
        ...
        <div id="drawer-create-product-default"
            ...
            <form action="{{ route('postMenu') }}" method="POST" enctype="multipart/form-data" >
                ...
                <div class="space-y-4">
                    ...
                    <!-- Menambahkan margin-top agar tombol tidak terlalu dekat dengan input gambar -->
    ...
    document.querySelectorAll(".updateProductButton").forEach((item) => {
        item.addEventListener("click", (event) => {
            ...
            console.log("Update Menu:", id, menu, harga, stok, kategori, deskripsi);
            ...
            const updateKategori = document.getElementById("updateKategori");
            for (let option of updateKategori.options) {
            ...
            // Ubah action form dengan ID menu
            document.getElementById("updateMenuForm").action = `/menu/${id}`;
...
// Fungsi untuk mengubah action form delete
