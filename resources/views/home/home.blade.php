...
@section('content')
  ...
  @endif
    ...
    <a href="#"
      ...
      <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Karyawan</h5>
    ...
    <a href="#"
      ...
      <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Penyalur</h5>
      <p class="font-normal text-gray-700 dark:text-gray-400"></p>
    </a>
    </div>
    <div
